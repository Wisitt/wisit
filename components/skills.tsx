...
const skills: SkillCategoryData[] = [
  {
    ...
    items: [
      { name: "React", icon: FaReact, color: "#61DAFB", proficiency: 90, experience: "≈2 years", note: "SPA, hooks, context, SSR" },
      { name: "Next.js", icon: SiNextdotjs, color: "#111827", proficiency: 90, experience: "≈2 years", note: "App Router & Pages" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "SCSS", icon: FaSass, color: "#CC6699", proficiency: 90, experience: "3+ years", note: "Organized stylesheets" },
      { name: "MUI", icon: SiMui, color: "#007FFF", proficiency: 85, experience: "≈1.5 years", note: "Component libraries" },
      { name: "Bootstrap", icon: SiBootstrap, color: "#7952B3", proficiency: 90, experience: "3+ years", note: "Rapid prototyping" },
      { name: "Shadcn UI", icon: SiShadcnui, color: "#9CA3AF", proficiency: 85, experience: "≈2 year", note: "Design systems" },
  ...
  },
  {
    ...
    items: [
      { name: "Node.js", icon: FaNodeJs, color: "#339933", proficiency: 80, experience: "≈2 years", note: "API & workers" },
      { name: "Express", icon: SiExpress, color: "#111827", proficiency: 80, experience: "≈2 year", note: "REST services" },
      ...
      { name: "Prisma", icon: SiPrisma, color: "#5A67D8", proficiency: 90, experience: "≈2 year", note: "Type-safe ORM" },
      { name: "AWS", icon: FaAws, color: "#FF9900", proficiency: 65, experience: "≈1.5 year", note: "S3, Lambda, IAM" },
      ...
      { name: "NestJS", icon: SiNestjs, color: "#E0234E", proficiency: 85, experience: "≈1 year", note: "Modular servers" },
  ...
  },
  {
    ...
    items: [
      { name: "Git", icon: FaGitAlt, color: "#F05032", proficiency: 100, experience: "2.5+ years", note: "Branching & CI" },
      { name: "Docker", icon: FaDocker, color: "#2496ED", proficiency: 70, experience: "≈1.5 year", note: "Containerization" },
  ...
  },
  {
    ...
    items: [{ name: "Cypress", icon: SiCypress, color: "#5A7184", proficiency: 80, experience: "≈2 years", note: "E2E testing" }],
  },
];
